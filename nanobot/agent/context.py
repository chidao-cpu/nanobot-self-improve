...
class ContextBuilder:
    ...
    def build_system_prompt(
        ...
        *,
        ...
        # Memory: returns frozen snapshot from MemoryEntryStore if attached
        memory_snapshot = self.memory.read_memory()
        if memory_snapshot and not self._is_template_content(memory_snapshot, "memory/MEMORY.md"):
