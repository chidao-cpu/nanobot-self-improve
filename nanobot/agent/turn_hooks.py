...
def build_agent_turn_hook(spec: AgentTurnHookSpec) -> AgentHook:
    ...
    # Always include registered hooks even in ephemeral mode
    # Only skip turn_hook_factories and turn_hooks for ephemeral runs
    if spec.ephemeral and not spec.run_extra_hooks_for_ephemeral:
        # Still include registered_hooks for tracking purposes
